...
export function HypotheekCalculator() {
  ...
  // Fixed rate for demonstration (would come from real data in production)
    ...
    >
      <div className="space-y-6">
        ...
        <div>
          ...
          >
            <option value="10">10 Jaar - {parseFloat('3.58').toFixed(2)}%</option>
            <option value="20">20 Jaar - {parseFloat('3.85').toFixed(2)}%</option>
            <option value="30">30 Jaar - {parseFloat('4.12').toFixed(2)}%</option>
          </select>
        </div>
