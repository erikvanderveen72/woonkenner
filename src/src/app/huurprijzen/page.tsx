...
// Huurgrenzen per 1 januari 2026 (Bron: Rijksoverheid / Volkshuisvesting Nederland)
// Sociaal: t/m €932,93 (t/m 143 WWS-punten)
// Middenhuur: €932,94 - €1.228,07 (144-186 WWS-punten, Wet betaalbare huur per 1 juli 2024)
// Vrije sector: boven €1.228,07 (187+ WWS-punten)
const maxHuurSociaal = 932.93;
const liberalisatiegrens = 1228.07;

const faqItems = [
  {
    question: 'Wat zijn de huurgrenzen in 2026?',
    answer: `Sinds de Wet betaalbare huur (1 juli 2024) zijn er drie huursegmenten: sociale huur (t/m €932,93, t/m 143 WWS-punten), middenhuur (€932,94 - €1.228,07, 144-186 punten) en vrije sector (boven €1.228,07). De liberalisatiegrens (bovengrens middensegment) is per 1 januari 2026 geïndexeerd naar €1.228,07. Bron: Rijksoverheid/Volkshuisvesting Nederland.`,
  },
  {
  ...
  {
    question: 'Wat is het verschil tussen sociaal, middenhuur en vrije sector?',
    answer: 'Sociale huur (t/m €932,93) is volledig gereguleerd via het puntensysteem. Middenhuur (€932,94 - €1.228,07) is sinds de Wet betaalbare huur ook gereguleerd met maximale huurprijzen. Vrije sector (boven €1.228,07) kent geen maximale huurprijs maar wel huurbescherming.',
  },
  {
