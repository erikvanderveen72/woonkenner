...
export function berekenMaxHuurprijs(punten: number): { maxHuur: number; sector: string } {
  // Woningwaarderingsstelsel 2026 - geïndexeerd per 1 jan 2026 (3,65%)
  // Bron: Rijksoverheid / Volkshuisvesting Nederland / Huurcommissie
  // Sociaal: t/m 143 punten (max €932,93)
  // Middenhuur: 144-186 punten (max €1.228,07) - Wet betaalbare huur
  // Vrije sector: 187+ punten
  const prijsPerPunt = 6.15; // geïndexeerd 2026
  if (punten <= 143) {
